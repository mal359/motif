 ...
 *  Description:
 *  -----------
 *  This data structure is used to keep track of window manager timers.  Each
 ...
 *  Description:
 *  -----------
 *  This data structure is used for drawing frame component graphics.
 *
 *************************************<->***********************************/
 ...
 *
 *  ClientData is instantiated at the time a client window is initially
...
typedef struct _WmGlobalData
{
    ...
    KeySpec     *F_NextKeySpec;         /* used when traversing to windows */
    KeySpec     *F_PrevKeySpec;         /* used when traversing to windows */
