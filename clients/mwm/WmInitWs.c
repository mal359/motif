 ...
 *
 *  We want to try to ignore the set of locking modifiers 
...
void InitWmGlobal (int argc, char *argv [], char *environ [])
{
    ...
    SetupWmSignalHandlers (0); /* dummy parameter */
 ...
 *  that the system backdrop directory (/usr/dt/backdrops) is in the 
