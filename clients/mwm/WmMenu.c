 ...
 *  Description:
 *  -----------
 *  This function creates an identical duplicate of the given menuItems
 *  list.
 *
 *
 *  Inputs:
 ...
 *  Description:
 *  -----------
 *  This function creates an identical duplicate of the given menu exclusions
 *  list.
 *
 *
 *  Inputs:
 ...
 *  Description:
 *  -----------
 *  This function creates an identical duplicate of the given menuSpec.
				 ...
				 String funcargs, Context greyed_context)
{
	    ...
	    strcmp(current->command_string, command_string) == 0)
	{
	    ...
	    /* Otherwise, we have already inserted this
 ...
 *  Outputs:
 *  -------
 *     returns true iff the tearoff control was enabled or disabled
