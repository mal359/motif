 ...
 *  Returns:
 *  --------
 *  Success if succeeded, otherwise failure code.
 * 
 *
 *  Outputs:
 *  -------
...
/*************************************<->*************************************
 *
 *  GetInitialPropertyList (ClientData *)
 *
 *
 *  Description:
 *  -----------
 ...
 *  Comments:
 *  --------
 *  The caller must XFree the paInitialialProperties member!
 * 
 *************************************<->***********************************/
...
/*************************************<->*************************************
 *
 *  DiscardInitialPropertyList (ClientData *)
 *
 *
 *  Description:
 *  -----------
 *  Tosses out the initial property list for a client, frees data
 *
 *
 *  Inputs:
 *  ------
