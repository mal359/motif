...

{
    ...
    /*
     * Retrieve and process SM_CLIENT_ID client window property info
...
ProcessWmNormalHints (ClientData *pCD, Boolean firstTime, long manageFlags)
{
    ...
    /*
     * Use a custom version of the Xlib routine to get WM_NORMAL_HINTS.
...
#ifdef R2_COMPAT
    /* 
     * Maintain R2 compatibility code for CND product xnm
     */
