...

{
  ...
  _MrmProcessLock();
  /*
   * Validate the hierarchy, then attempt to fetch the module.
   */
			...
			MrmType			*class_return)
{
  ...
  /*
   * Validate the hierarchy, then attempt to fetch the widget
   */
  if ( hierarchy_id == NULL )
    {
		   ...
		   Cardinal                    num_args)
{
  ...
  /*
   * Validate the hierarchy, then attempt to modify the widget
   */
  if ( hierarchy_id == NULL )
    {
